import { BrowserRouter as Router, Routes, Route, Link } from "react-router-dom"; // aggiunta
import Navbar from "./components/Navbar";
import FullScreenSection from "./components/FullScreenSection";
import Footer from "./components/Footer";
import AlimentazioneSana from "./pages/AlimentazioneSana"; // nuova pagina
  ...
  return (
    <Router>
      ...
      <Routes>
          ...
          element={
            <>
              ...
              <FullScreenSection type="secondary" bg="#B4F5FA">
                <Link to="/alimentazione-sana" style={{ textDecoration: "none", color: "inherit" }}>
                  <h2 style={{ cursor: "pointer" }}>Alimentazione sana</h2>
                </Link>
                <p>
        ...
        />
        <Route path="/alimentazione-sana" element={<AlimentazioneSana />} />
      </Routes>
      <Footer />
    </Router>
  );
